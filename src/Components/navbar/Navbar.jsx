        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    {/* Home Page Link  */}
                    <Link to={'/'} className="flex items-center mr-4 cursor-pointer py-1.5 text-xl font-bold gap-2">
                        {/* Logo Image  */}
                        <img
                            className='w-10 h-10'
                            src={Logo}
                        ...
                        />
                        {/* Logo Text  */}
                        <span style={{ color: mode === 'dark' ? 'white' : 'white' }}>
                            Bloggi
                        </span>
                    </Link>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Search Icon */}
                        <div>
                            <SearchDialog size={20} color="white" />
                        </div>

                        {/* Share Icon */}
                        <div className="hidden lg:block">
                            <ShareDialogBox size={20} color="white" />
                        </div>
